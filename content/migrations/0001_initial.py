# Generated by Django 4.2 on 2025-05-06 07:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.SlugField(choices=[('aba-therapy', 'ABA-терапия'), ('adaptive-physical-culture', 'Адаптивная физкультура'), ('creative-workshops', 'Творческие мастерские'), ('resource-classes', 'Ресурсные классы'), ('children-leisure', 'Досуг для детей')], max_length=255, unique=True, verbose_name='Направление деятельности')),
            ],
        ),
        migrations.CreateModel(
            name='Partner',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='content.page', verbose_name='Страница')),
            ],
            options={
